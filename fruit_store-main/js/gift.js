/**
 * Gift Page JavaScript (Updated for LocalStorage)
...
async function initGiftPage() {
  try {
    ...
    // Filter only gift products (Lọc sản phẩm quà tặng)
    ...
    console.log(`Total gift products: ${allProducts.length}`);
  } catch (error) {
